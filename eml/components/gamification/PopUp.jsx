...
export default function PopUp({ pointAmount, isCorrectAnswer }) {
    ...
    const customEasing = (value) => {
        ...
        const power = 2; // Determines the rate of change
    ...
    useEffect(() => {
        ...
        const initializePopup = async () => {
            try {
                const firstName = await fetchUserFirstName();
                if (mounted) {
        ...
        return () => {
            ...
            animatedPopUpValue.setValue(0);
            animatedPointValue.setValue(0);
