...
import { Alert, View, TouchableOpacity, Image, Pressable } from 'react-native';
                    ...
                    <View className="flex-[1] flex-col bg-secondary">
                        ...
                        <View>
                            {sections.map((section, i) => {
                                const completedComponents = sectionProgress[section.sectionId] || 0;
                                    return <SectionCard key={i} section={section} course={course} progress={completedComponents} onPress={() => navigateToSpecifiedSection(section)}></SectionCard>;
                            })}
                        </View>
                    </View>
                )
